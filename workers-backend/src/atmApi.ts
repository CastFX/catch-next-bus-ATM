...
export const fetchTimetableData = async (
  ...
  if (response.status !== 200) {
    console.log(
      "Error while fetching timetable: " +
        lineId +
        ", status: " +
        response.statusText
    );
